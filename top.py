    ...
    def mb_input(self, start_addr, data):
        if self.mb_cells_idx is not None:
            ...
            if post:
                ...
                if data[self.mb_cells_idx - start_addr + 6] != post.func_frequencies[FuncNames.INTENSIVE]:
                    post.set_func_pump_frequency(FuncNames.INTENSIVE, data[self.mb_cells_idx - start_addr + 6])
        ...
        if self.mb_cells_idx is not None:
            ...
            if post:
                post_data = [
                    ...
                    int(post.func_frequencies[FuncNames.INTENSIVE]),
